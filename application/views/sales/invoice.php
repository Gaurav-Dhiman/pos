	...
	<table id="items">
		...
		?>
			<tr class="item-row">
				...
				<td class="item-name"><textarea rows="4" cols="6"><?php echo  $item['name'];//echo ($item['is_serialized'] || $item['allow_alt_description']) && !empty($item['description']) ? $item['description'] : $item['name']; ?></textarea></td>
